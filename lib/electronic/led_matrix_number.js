...
var LedMatrixNumber = function (_LedMatrixBase) {
  _inherits(LedMatrixNumber, _LedMatrixBase);

  function LedMatrixNumber(port) {
    _classCallCheck(this, LedMatrixNumber);

    var _this = _possibleConstructorReturn(this, (LedMatrixNumber.__proto__ || Object.getPrototypeOf(LedMatrixNumber)).call(this, port));
