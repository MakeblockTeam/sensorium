...
var Humiture = function (_Electronic) {
  _inherits(Humiture, _Electronic);

  function Humiture(port) {
    _classCallCheck(this, Humiture);

    var _this = _possibleConstructorReturn(this, (Humiture.__proto__ || Object.getPrototypeOf(Humiture)).call(this));
