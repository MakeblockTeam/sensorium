...
var GPIOContinue = function (_Electronic) {
  _inherits(GPIOContinue, _Electronic);

  function GPIOContinue(port, key) {
    _classCallCheck(this, GPIOContinue);

    var _this = _possibleConstructorReturn(this, (GPIOContinue.__proto__ || Object.getPrototypeOf(GPIOContinue)).call(this));
