...
var Potentionmeter = function (_Electronic) {
  _inherits(Potentionmeter, _Electronic);

  function Potentionmeter(port) {
    _classCallCheck(this, Potentionmeter);

    var _this = _possibleConstructorReturn(this, (Potentionmeter.__proto__ || Object.getPrototypeOf(Potentionmeter)).call(this));
