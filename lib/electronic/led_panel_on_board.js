...
var LedPanelOnBoard = function (_RgbLedBase) {
  _inherits(LedPanelOnBoard, _RgbLedBase);

  function LedPanelOnBoard() {
    _classCallCheck(this, LedPanelOnBoard);

    return _possibleConstructorReturn(this, (LedPanelOnBoard.__proto__ || Object.getPrototypeOf(LedPanelOnBoard)).call(this, 0, 2));
  }

  //主控支持戳：描述各主控的支持情况


  _createClass(LedPanelOnBoard, null, [{
    key: 'supportStamp',
