...
var _GyroBase2 = require('./base/GyroBase');
...
var GyroOnBoard = function (_GyroBase) {
  _inherits(GyroOnBoard, _GyroBase);

  function GyroOnBoard() {
    _classCallCheck(this, GyroOnBoard);

    return _possibleConstructorReturn(this, (GyroOnBoard.__proto__ || Object.getPrototypeOf(GyroOnBoard)).call(this, 1));
  }

  _createClass(GyroOnBoard, null, [{
    key: 'supportStamp',
