...
var RgbLed = function (_RgbLedBase) {
  _inherits(RgbLed, _RgbLedBase);

  function RgbLed(port, slot) {
    _classCallCheck(this, RgbLed);

    return _possibleConstructorReturn(this, (RgbLed.__proto__ || Object.getPrototypeOf(RgbLed)).call(this, port, slot));
  }

  _createClass(RgbLed, null, [{
    key: 'supportStamp',
