...
var LineFollower = function (_Electronic) {
  _inherits(LineFollower, _Electronic);

  function LineFollower(port) {
    _classCallCheck(this, LineFollower);

    var _this = _possibleConstructorReturn(this, (LineFollower.__proto__ || Object.getPrototypeOf(LineFollower)).call(this));
