...
var LimitSwitch = function (_Electronic) {
  _inherits(LimitSwitch, _Electronic);

  function LimitSwitch(port, slot) {
    _classCallCheck(this, LimitSwitch);

    var _this = _possibleConstructorReturn(this, (LimitSwitch.__proto__ || Object.getPrototypeOf(LimitSwitch)).call(this));
