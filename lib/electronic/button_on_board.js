...
var ServoMotor = function (_Electronic) {
  ...
  _createClass(ServoMotor, [{
    key: 'run',
    value: function run() {
      var buf = _utils2.default.composer(_cmd2.default.ButtonOnBoard, [this.args.port, this.args.slot, this.args.angle]);
