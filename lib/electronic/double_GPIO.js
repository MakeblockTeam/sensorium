...
var DoubleGPIO = function (_Electronic) {
  _inherits(DoubleGPIO, _Electronic);

  function DoubleGPIO(port1, port2) {
    _classCallCheck(this, DoubleGPIO);

    var _this = _possibleConstructorReturn(this, (DoubleGPIO.__proto__ || Object.getPrototypeOf(DoubleGPIO)).call(this));
