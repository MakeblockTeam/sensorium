...
var SoundBase = function (_Electronic) {
  _inherits(SoundBase, _Electronic);

  function SoundBase(port) {
    _classCallCheck(this, SoundBase);

    var _this = _possibleConstructorReturn(this, (SoundBase.__proto__ || Object.getPrototypeOf(SoundBase)).call(this));
