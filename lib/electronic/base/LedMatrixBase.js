...
var LedMatrixBase = function (_Electronic) {
  _inherits(LedMatrixBase, _Electronic);

  /**
   * LedMatrix 类，led模块
   */
  function LedMatrixBase(port) {
    _classCallCheck(this, LedMatrixBase);

    var _this = _possibleConstructorReturn(this, (LedMatrixBase.__proto__ || Object.getPrototypeOf(LedMatrixBase)).call(this));
