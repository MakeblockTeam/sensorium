...
var GyroBase = function (_Electronic) {
  _inherits(GyroBase, _Electronic);

  function GyroBase(port) {
    _classCallCheck(this, GyroBase);

    var _this = _possibleConstructorReturn(this, (GyroBase.__proto__ || Object.getPrototypeOf(GyroBase)).call(this));
