...
var RgbLedOnBoard = function (_RgbLedBase) {
  _inherits(RgbLedOnBoard, _RgbLedBase);

  function RgbLedOnBoard() {
    _classCallCheck(this, RgbLedOnBoard);

    return _possibleConstructorReturn(this, (RgbLedOnBoard.__proto__ || Object.getPrototypeOf(RgbLedOnBoard)).call(this, 0, 2));
  }

  _createClass(RgbLedOnBoard, null, [{
    key: 'supportStamp',
