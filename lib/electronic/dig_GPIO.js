...
var DigGPIO = function (_Electronic) {
  _inherits(DigGPIO, _Electronic);

  function DigGPIO(port) {
    _classCallCheck(this, DigGPIO);

    var _this = _possibleConstructorReturn(this, (DigGPIO.__proto__ || Object.getPrototypeOf(DigGPIO)).call(this));
