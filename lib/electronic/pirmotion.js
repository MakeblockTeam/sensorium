...
var Pirmotion = function (_Electronic) {
  _inherits(Pirmotion, _Electronic);

  function Pirmotion(port) {
    _classCallCheck(this, Pirmotion);

    var _this = _possibleConstructorReturn(this, (Pirmotion.__proto__ || Object.getPrototypeOf(Pirmotion)).call(this));
