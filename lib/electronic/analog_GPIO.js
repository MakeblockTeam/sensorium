...
var AnalogGPIO = function (_Electronic) {
  _inherits(AnalogGPIO, _Electronic);

  function AnalogGPIO(port) {
    _classCallCheck(this, AnalogGPIO);

    var _this = _possibleConstructorReturn(this, (AnalogGPIO.__proto__ || Object.getPrototypeOf(AnalogGPIO)).call(this));
