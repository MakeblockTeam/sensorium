...
var FourKeys = function (_Electronic) {
  _inherits(FourKeys, _Electronic);

  function FourKeys(port) {
    _classCallCheck(this, FourKeys);

    var _this = _possibleConstructorReturn(this, (FourKeys.__proto__ || Object.getPrototypeOf(FourKeys)).call(this));
