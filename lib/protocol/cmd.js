...
function protocolAssembler() {
  ...
  this.setEncoderMotor = function (port, slot, speed, angle) {
    ...
    return bufAssembler.apply(undefined, [{ mode: 0x02, id: 0x0c }, port, slot, speed & 0xff, speed >> 8 & 0xff].concat(_toConsumableArray(byte4Array)));
  };
  ...
  this.setSevenSegment = function (port, number) {
    ...
    return bufAssembler.apply(undefined, [{ mode: 0x02, id: 0x09 }, port].concat(_toConsumableArray(byte4Array)));
  };
  ...
  this.setLedMatrixEmotion = function (port, xAxis, yAxis, emotionData) {
    ...
    return bufAssembler.apply(undefined, [{ mode: 0x02, id: 0x29 }, port, 0x02, xAxis, yAxis].concat(_toConsumableArray(emotionData)));
  };
  ...
  this.setLedMatrixNumber = function (port, number) {
    var byte4Array = _utils2.default.float32ToBytes(number);
    return bufAssembler.apply(undefined, [{ mode: 0x02, id: 0x29 }, port, 0x04].concat(_toConsumableArray(byte4Array)));
    // byte4Array[0],
    // byte4Array[1],
    // byte4Array[2],
    // byte4Array[3]);
